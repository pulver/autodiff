...
template <typename T> T f(const T& w, const T& x, const T& y, const T& z) {
  using namespace std;
...
int main() {
  ...
  std::cout << std::setprecision(std::numeric_limits<cpp_bin_float_50>::digits10) << "mathematica   : " << answer
            << '\n'
