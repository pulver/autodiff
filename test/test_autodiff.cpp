...
{
    boost::mpl::for_each(bin_float_types, iround_and_itrunc_test());
    boost::mpl::for_each(multiprecision_float_types, iround_and_itrunc_test());
}
...
{
    boost::mpl::for_each(bin_float_types, lambert_w0_test_test());
    boost::mpl::for_each(multiprecision_float_types, lambert_w0_test_test());
}
...
{
    boost::mpl::for_each(bin_float_types, lround_llround_truncl_test());
    boost::mpl::for_each(multiprecision_float_types, lround_llround_truncl_test());
}
...
{
    boost::mpl::for_each(bin_float_types, mixed_partials_test());
}
...
{
    boost::mpl::for_each(bin_float_types, black_scholes_test());
}
*/
