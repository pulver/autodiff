...
BOOST_AUTO_TEST_CASE_TEMPLATE(pow2, T, bin_float_types) {
  ...
  const T mathematica[] {
    4*root_two<T>(),
    4*root_two<T>()*ln_two<T>(),
    4*root_two<T>()*pow(ln_two<T>(),2),
    4*root_two<T>()*pow(ln_two<T>(),3),
    4*root_two<T>()*pow(ln_two<T>(),4),
    4*root_two<T>()*pow(ln_two<T>(),5),
    5*root_two<T>(),
    2*root_two<T>()*(1 + (5*ln_two<T>())/2),
    2*root_two<T>()*ln_two<T>()*(2 + (5*ln_two<T>())/2),
    2*root_two<T>()*pow(ln_two<T>(),2)*(3 + (5*ln_two<T>())/2),
    2*root_two<T>()*pow(ln_two<T>(),3)*(4 + (5*ln_two<T>())/2),
    2*root_two<T>()*pow(ln_two<T>(),4)*(5 + (5*ln_two<T>())/2),
    15/(2*root_two<T>()),
    root_two<T>()*(4 + (15*ln_two<T>())/4),
    root_two<T>()*(2 + 8*ln_two<T>() + (15*pow(ln_two<T>(),2))/4),
    root_two<T>()*ln_two<T>()*(6 + 12*ln_two<T>() + (15*pow(ln_two<T>(),2))/4),
    root_two<T>()*pow(ln_two<T>(),2)*(12 + 16*ln_two<T>() + (15*pow(ln_two<T>(),2))/4),
    root_two<T>()*pow(ln_two<T>(),3)*(20 + 20*ln_two<T>() + (15*pow(ln_two<T>(),2))/4),
    15/(8*root_two<T>()),
    (23/4.0 + (15*ln_two<T>())/8)/root_two<T>(),
    (9 + (23*ln_two<T>())/2 + (15*pow(ln_two<T>(),2))/8)/root_two<T>(),
    (6 + 27*ln_two<T>() + (69*pow(ln_two<T>(),2))/4 + (15*pow(ln_two<T>(),3))/8)/root_two<T>(),
    (ln_two<T>()*(24 + 54*ln_two<T>() + 23*pow(ln_two<T>(),2) + (15*pow(ln_two<T>(),3))/8))/root_two<T>(),
    (pow(ln_two<T>(),2)*(60 + 90*ln_two<T>() + (115*pow(ln_two<T>(),2))/4 + (15*pow(ln_two<T>(),3))/8))/root_two<T>(),
    -15/(32*root_two<T>()),
    (-1 - (15*ln_two<T>())/16)/(2*root_two<T>()),
    (7 - 2*ln_two<T>() - (15*pow(ln_two<T>(),2))/16)/(2*root_two<T>()),
    (24 + 21*ln_two<T>() - 3*pow(ln_two<T>(),2) - (15*pow(ln_two<T>(),3))/16)/(2*root_two<T>()),
    (24 + 96*ln_two<T>() + 42*pow(ln_two<T>(),2) - 4*pow(ln_two<T>(),3) - (15*pow(ln_two<T>(),4))/16)/(2*root_two<T>()),
    (ln_two<T>()*(120 + 240*ln_two<T>() + 70*pow(ln_two<T>(),2) - 5*pow(ln_two<T>(),3) - (15*pow(ln_two<T>(),4))/16))/(2*root_two<T>()),
    45/(128*root_two<T>()),
    (9/16.0 + (45*ln_two<T>())/32)/(4*root_two<T>()),
    (-25/2.0 + (9*ln_two<T>())/8 + (45*pow(ln_two<T>(),2))/32)/(4*root_two<T>()),
    (-15 - (75*ln_two<T>())/2 + (27*pow(ln_two<T>(),2))/16 + (45*pow(ln_two<T>(),3))/32)/(4*root_two<T>()),
    (60 - 60*ln_two<T>() - 75*pow(ln_two<T>(),2) + (9*pow(ln_two<T>(),3))/4 + (45*pow(ln_two<T>(),4))/32)/(4*root_two<T>()),
    (120 + 300*ln_two<T>() - 150*pow(ln_two<T>(),2) - 125*pow(ln_two<T>(),3) + (45*pow(ln_two<T>(),4))/16 + (45*pow(ln_two<T>(),5))/32)/(4*root_two<T>())};
  unsigned k=0;
