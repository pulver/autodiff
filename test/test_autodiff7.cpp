...
BOOST_AUTO_TEST_CASE_TEMPLATE(expm1_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(boost::math::expm1(make_fvar<T, m>(x)).derivative(0u), boost::math::expm1(x),
  ...
  for (auto i : boost::irange(static_cast<unsigned>(test_constants::n_samples))) {
    {
      ...
      BOOST_CHECK_CLOSE(autodiff_v.derivative(0u), fact_i, 50 * test_constants::pct_epsilon());
    }
...
BOOST_AUTO_TEST_CASE_TEMPLATE(fpclassify_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_EQUAL(fpclassify(make_fvar<T, m>(std::numeric_limits<T>::infinity())), FP_INFINITE);
    BOOST_CHECK_EQUAL(fpclassify(make_fvar<T, m>(std::numeric_limits<T>::quiet_NaN())), FP_NAN);
    if (std::numeric_limits<T>::has_denorm != std::denorm_absent) {
      BOOST_CHECK_EQUAL(fpclassify(make_fvar<T, m>(std::numeric_limits<T>::denorm_min())), FP_SUBNORMAL);
    }

    BOOST_CHECK(isfinite(make_fvar<T, m>(0)));
    BOOST_CHECK(isnormal(make_fvar<T, m>((std::numeric_limits<T>::min)())));
    BOOST_CHECK(!isnormal(make_fvar<T, m>(std::numeric_limits<T>::denorm_min())));
...
BOOST_AUTO_TEST_CASE_TEMPLATE(gamma_hpp, T, bin_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    auto z = z_sampler.next();
    {
      ...
      BOOST_CHECK_CLOSE(autodiff_v.derivative(0u), anchor_v, 2.5e5 * test_constants::pct_epsilon());
    }
...

    {
      ...
      BOOST_CHECK_CLOSE(lgamma(make_fvar<T, m>(z).derivative(0u), std::addressof(s1)),
                          lgamma(z, std::addressof(s2)), 2.5e5 * test_constants::pct_epsilon());
      BOOST_CHECK((std::addressof(s1) == nullptr && std::addressof(s2) == nullptr) || (s1 == s2));
    }
...
/* BOOST_AUTO_TEST_CASE_TEMPLATE(hankel_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      ...
      BOOST_CHECK_THROW(boost::math::cyl_hankel_1(make_fvar<T,m>(v), make_fvar<T,m>(x)),
boost::wrapexcept<std::domain_error>); BOOST_CHECK_THROW(boost::math::cyl_hankel_1(v, x),
boost::wrapexcept<std::domain_error>); } catch (const std::overflow_error &) {
      BOOST_CHECK_THROW(boost::math::cyl_hankel_1(make_fvar<T,m>(v), make_fvar<T,m>(x)),
boost::wrapexcept<std::overflow_error>); BOOST_CHECK_THROW(boost::math::cyl_hankel_1(v, x),
...
std::rethrow_exception(std::exception_ptr(std::current_exception()));
    ...
    try {
      ...
      BOOST_CHECK_THROW(boost::math::cyl_hankel_2(make_fvar<T,m>(v), make_fvar<T,m>(x)),
boost::wrapexcept<std::domain_error>); BOOST_CHECK_THROW(boost::math::cyl_hankel_2(v, x),
boost::wrapexcept<std::domain_error>); } catch (const std::overflow_error &) {
      BOOST_CHECK_THROW(boost::math::cyl_hankel_2(make_fvar<T,m>(v), make_fvar<T,m>(x)),
boost::wrapexcept<std::overflow_error>); BOOST_CHECK_THROW(boost::math::cyl_hankel_2(v, x),
boost::wrapexcept<std::overflow_error>); } catch (...) { std::cout << std::setprecision(20) << "Input: x: " << x<< "
max: "<< std::numeric_limits<T>::max() << std::endl;
std::rethrow_exception(std::exception_ptr(std::current_exception()));
    }
    ...
    try {
      ...
      BOOST_CHECK_THROW(boost::math::sph_hankel_1(make_fvar<T,m>(v), make_fvar<T,m>(x)),
boost::wrapexcept<std::domain_error>); BOOST_CHECK_THROW(boost::math::sph_hankel_1(v, x),
boost::wrapexcept<std::domain_error>); } catch (const std::overflow_error &) {
      BOOST_CHECK_THROW(boost::math::sph_hankel_1(make_fvar<T,m>(v), make_fvar<T,m>(x)),
boost::wrapexcept<std::overflow_error>); BOOST_CHECK_THROW(boost::math::sph_hankel_1(v, x),
boost::wrapexcept<std::overflow_error>); } catch (...) { std::cout << std::setprecision(20) << "Input: x: " << x<< "
max: "<< std::numeric_limits<T>::max() << std::endl;
std::rethrow_exception(std::exception_ptr(std::current_exception()));
    }
    ...
    try {
      ...
      BOOST_CHECK_THROW(boost::math::sph_hankel_2(make_fvar<T,m>(v), make_fvar<T,m>(x)),
boost::wrapexcept<std::domain_error>); BOOST_CHECK_THROW(boost::math::sph_hankel_2(v, x),
boost::wrapexcept<std::domain_error>); } catch (const std::overflow_error &) {
      BOOST_CHECK_THROW(boost::math::sph_hankel_2(make_fvar<T,m>(v), make_fvar<T,m>(x)),
boost::wrapexcept<std::overflow_error>); BOOST_CHECK_THROW(boost::math::sph_hankel_2(v, x),
boost::wrapexcept<std::overflow_error>); } catch (...) { std::cout << std::setprecision(20) << "Input: x: " << x<< "
max: "<< std::numeric_limits<T>::max() << std::endl;
std::rethrow_exception(std::exception_ptr(std::current_exception()));
    }
