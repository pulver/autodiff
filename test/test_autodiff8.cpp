...
BOOST_AUTO_TEST_CASE_TEMPLATE(heuman_lambda_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(boost::math::heuman_lambda(make_fvar<T, m>(x), make_fvar<T, m>(phi)).derivative(0u),
...
BOOST_AUTO_TEST_CASE_TEMPLATE(hypot_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(boost::math::hypot(make_fvar<T, m>(x), make_fvar<T, m>(y)).derivative(0u), boost::math::hypot(x, y),
...
BOOST_AUTO_TEST_CASE_TEMPLATE(jacobi_elliptic_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(boost::math::jacobi_cd(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_cd(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_cn(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_cn(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_cs(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_cs(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_dc(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_dc(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_dn(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_dn(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_ds(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_ds(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_nc(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_nc(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_nd(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_nd(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_ns(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_ns(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_sc(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_sc(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_sd(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
                        boost::math::jacobi_sd(k, theta), 50 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::jacobi_sn(make_fvar<T, m>(k), make_fvar<T, m>(theta)).derivative(0u),
...
BOOST_AUTO_TEST_CASE_TEMPLATE(jacobi_zeta_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    auto x = x_sampler.next();
    auto phi = phi_sampler.next();
    BOOST_CHECK_CLOSE(boost::math::jacobi_zeta(make_fvar<T, m>(x), make_fvar<T, m>(phi)).derivative(0u),
...
BOOST_AUTO_TEST_CASE_TEMPLATE(lambert_w_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
...

    {
      ...
      BOOST_CHECK_CLOSE(boost::math::lambert_wm1(make_fvar<T, m>(x_)).derivative(0u), boost::math::lambert_wm1(x_),
                          50*test_constants::pct_epsilon());
      BOOST_CHECK_CLOSE(boost::math::lambert_wm1_prime(make_fvar<T, m>(x_)).derivative(0u), boost::math::lambert_wm1_prime(x_),
                          50*test_constants::pct_epsilon());
    }
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(log1p_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    std::ignore = i;
    auto x = x_sampler.next();
    BOOST_CHECK_CLOSE(log1p(make_fvar<T, m>(x)).derivative(0u), log1p(x),
                        50 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(next_hpp, T, all_float_types) {
  ...
  static constexpr auto m = test_constants::order;
  for (auto i : boost::irange(test_constants::n_samples)) {
    BOOST_CHECK_CLOSE(boost::math::float_next(make_fvar<T, m>(static_cast<T>(i))).derivative(0u),
                        boost::math::float_next(static_cast<T>(i)), test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::float_prior(make_fvar<T, m>(static_cast<T>(i))).derivative(0u),
                        boost::math::float_prior(static_cast<T>(i)), test_constants::pct_epsilon());

    BOOST_CHECK_CLOSE(boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), make_fvar<T, m>(static_cast<T>(1))).derivative(0u),
                        boost::math::nextafter(static_cast<T>(i), static_cast<T>(1)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(
        boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), make_fvar<T, m>(static_cast<T>(i + 2))).derivative(0u),
        boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), static_cast<T>(i + 2)),
        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(
        boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), make_fvar<T, m>(static_cast<T>(i + 1))).derivative(0u),
        boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), static_cast<T>(i + 2)),
        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), make_fvar<T, m>(static_cast<T>(-1))).derivative(0u),
                        boost::math::nextafter(static_cast<T>(i), static_cast<T>(-1)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(
        boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), make_fvar<T, m>(static_cast<T>(-1 * (i + 2)))).derivative(0u),
        boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), static_cast<T>(-1 * (i + 2))),
        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(
        boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), make_fvar<T, m>(static_cast<T>(-1 * (i + 1)))).derivative(0u),
        boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), static_cast<T>(-1 * (i + 2))),
        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::nextafter(make_fvar<T, m>(static_cast<T>(i)), make_fvar<T, m>(static_cast<T>(i))).derivative(0u),
                        ((make_fvar<T, m>(static_cast<T>(i)))), test_constants::pct_epsilon());

    BOOST_CHECK_CLOSE(boost::math::float_advance(make_fvar<T, m>(static_cast<T>(i)), 1).derivative(0u),
                        boost::math::float_advance(static_cast<T>(i), 1), test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::float_advance(make_fvar<T, m>(static_cast<T>(i)), i + 2).derivative(0u),
                        boost::math::float_advance(make_fvar<T, m>(static_cast<T>(i)), i + 2),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(
        boost::math::float_advance(make_fvar<T, m>(static_cast<T>(i)), i + 1).derivative(0u),
    ...
    BOOST_CHECK_CLOSE(
        ...
        boost::math::float_advance(boost::math::float_advance(make_fvar<T, m>(static_cast<T>(i)), -i - 2), 1),
        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::float_advance(make_fvar<T, m>(static_cast<T>(i)), 0).derivative(0u),
                        ((make_fvar<T, m>(static_cast<T>(i)))), test_constants::pct_epsilon());

    BOOST_CHECK_CLOSE(boost::math::float_distance(make_fvar<T, m>(static_cast<T>(i)).derivative(0u), static_cast<T>(i)),
                        static_cast<T>(0), test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::float_distance(boost::math::float_next(make_fvar<T, m>(static_cast<T>(i))),
                                                    make_fvar<T, m>(static_cast<T>(i))).derivative(0u),
                        ((make_fvar<T, m>(-1))), test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::float_distance(boost::math::float_prior(make_fvar<T, m>(static_cast<T>(i))),
                                                    make_fvar<T, m>(static_cast<T>(i))).derivative(0u),
                        ((make_fvar<T, m>(1))), test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(owens_t_hpp, T, bin_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(autodiff_v.derivative(0u), anchor_v, 1e5 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(pow_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(10)) {
    BOOST_CHECK_CLOSE(boost::math::pow<0>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<0>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<1>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<1>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<2>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<2>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<3>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<3>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<4>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<4>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<5>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<5>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<6>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<6>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<7>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<7>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<8>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<8>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(boost::math::pow<9>(make_fvar<T, m>(static_cast<T>(i))).derivative(0u), boost::math::pow<9>(static_cast<T>(i)),
                        test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(powm1_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(autodiff_v.derivative(0u), anchor_v, 2e6 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(sin_pi_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    std::ignore = i;
    auto x = x_sampler.next();
    BOOST_CHECK_CLOSE(boost::math::sin_pi(make_fvar<T, m>(x)).derivative(0u), boost::math::sin_pi(x),
                        test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(spherical_harmonic_hpp, T, all_float_types) {
  ...
  for (auto n : boost::irange(1u, static_cast<unsigned>(test_constants::n_samples) + 1u)) {
    ...
    auto r = (std::min)(static_cast<int>(n) - 1, r_sampler.next());
    {
      ...
      BOOST_CHECK_CLOSE(autodiff_v.real(), anchor_v.real(), 2.5e4 * test_constants::pct_epsilon());
      BOOST_CHECK_CLOSE(autodiff_v.imag(), anchor_v.imag(), 2.5e4 * test_constants::pct_epsilon());
    }

    {
      ...
      BOOST_CHECK_CLOSE(autodiff_v.derivative(0u), anchor_v, 2.5e4 * test_constants::pct_epsilon());
    }
...
BOOST_AUTO_TEST_CASE_TEMPLATE(sqrt1pm1_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    std::ignore = i;
    auto x = x_sampler.next();
    BOOST_CHECK_CLOSE(boost::math::sqrt1pm1(make_fvar<T, m>(x)), boost::math::sqrt1pm1(x),
                        50 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(trigamma_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    std::ignore = i;
    auto x = x_sampler.next();
    BOOST_CHECK_CLOSE(boost::math::trigamma(make_fvar<T, m>(x)), boost::math::trigamma(x),
                        50 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(zeta_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    std::ignore = i;
    auto x = x_sampler.next();
    BOOST_CHECK_CLOSE(boost::math::zeta(make_fvar<T, m>(x)), boost::math::zeta(x),
