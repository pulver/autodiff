...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_1_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      ...
      std::cerr << "Inputs: k: " << k << std::endl;
    }

    try {
      BOOST_CHECK_CLOSE(boost::math::ellint_1(make_fvar<T, m>(k), make_fvar<T, m>(phi)).derivative(0u),
                        boost::math::ellint_1(k, phi),
                        1e4 * test_constants::pct_epsilon());
    } catch (...) {
      std::cerr << "Inputs: k: " << k << " phi: " << phi << std::endl;
    }
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_2_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      BOOST_CHECK_CLOSE(boost::math::ellint_2(make_fvar<T, m>(k), make_fvar<T, m>(phi)).derivative(0u),
                        boost::math::ellint_2(k, phi),
                        2.5e3 * test_constants::pct_epsilon());
    } catch (...) {
      std::cerr << "Inputs: k: " << k << " phi: " << phi << std::endl;
    }
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_3_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      BOOST_CHECK_CLOSE(
          boost::math::ellint_3(make_fvar<T, m>(k), make_fvar<T, m>(n), make_fvar<T, m>(phi)).derivative(0u),
          boost::math::ellint_3(k, n, phi),
          2.5e3 * test_constants::pct_epsilon());
    } catch (...) {
      std::cerr << "Inputs: k: " << k << " n: " << n << " phi: " << phi << std::endl;
    }
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_d_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      BOOST_CHECK_CLOSE(boost::math::ellint_d(make_fvar<T, m>(k), make_fvar<T, m>(phi)).derivative(0u),
                        boost::math::ellint_d(k, phi),
                        2.5e3 * test_constants::pct_epsilon());
    } catch (...) {
      std::cerr << "Inputs: k: " << k << " phi: " << phi << std::endl;
    }
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rf_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      BOOST_CHECK_CLOSE(
          boost::math::ellint_rf(make_fvar<T, m>(x), make_fvar<T, m>(y), make_fvar<T, m>(z)).derivative(0u),
          boost::math::ellint_rf(x, y, z),
          2.5e3 * test_constants::pct_epsilon());
    } catch (...) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rc_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      BOOST_CHECK_CLOSE(boost::math::ellint_rc(make_fvar<T, m>(x), make_fvar<T, m>(y)).derivative(0u),
                        boost::math::ellint_rc(x, y),
                        2.5e3 * test_constants::pct_epsilon());
    } catch (...) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rj_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      BOOST_CHECK_CLOSE(boost::math::ellint_rj(
                            make_fvar<T, m>(x), make_fvar<T, m>(y), make_fvar<T, m>(z), make_fvar<T, m>(p))
                            .derivative(0u),
                        boost::math::ellint_rj(x, y, z, p),
                        2.5e3 * test_constants::pct_epsilon());
    } catch (...) {
      std::cerr << "Inputs: x: " << x << " y: " << y << " z: " << z << " p: " << p << std::endl;
    }
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rd_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      BOOST_CHECK_CLOSE(
          boost::math::ellint_rd(make_fvar<T, m>(x), make_fvar<T, m>(y), make_fvar<T, m>(z)).derivative(0u),
          boost::math::ellint_rd(x, y, z),
          2.5e3 * test_constants::pct_epsilon());
    } catch (...) {
        std::cerr << "Inputs: x: " << x << " y: " << y << " z: " << z << std::endl;
    }
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rg_hpp, T, all_float_types) {
  ...
  for (auto i : boost::irange(test_constants::n_samples)) {
    ...
    try {
      BOOST_CHECK_CLOSE(
          boost::math::ellint_rg(make_fvar<T, m>(x), make_fvar<T, m>(y), make_fvar<T, m>(z)).derivative(0u),
          boost::math::ellint_rg(x, y, z),
